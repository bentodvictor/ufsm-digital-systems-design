...
add wave -noupdate -format Logic -radix hexadecimal /mips_monocycle_tb/mips_monocycle/reset
add wave -noupdate -format Logic -radix hexadecimal /mips_monocycle_tb/mips_monocycle/clock
add wave -noupdate -format Literal -radix hexadecimal /mips_monocycle_tb/mips_monocycle/instructionaddress
add wave -noupdate -format Literal -radix hexadecimal /mips_monocycle_tb/mips_monocycle/decodedinstruction
